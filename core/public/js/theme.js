...
$(function () {
  ...
  $('input[type="file"]').on('change', function () {
    if (this.files && this.files[0]) {
      ...
      reader.onload = function (e) {
        if (input.hasClass('attach')) {
          input.parent().find('.filePreview').html(files[0].name);
        } else {
          input.parent().find('.filePreview').html('<img width="50" src="' + e.target.result + '">');
        }
      };
  ...
  $('.summernote').summernote({
    ...
    ['style', ['bold', 'italic', 'underline', 'clear']], ['insert', ['link']], ['height', ['height']], ['view', ['codeview']]]
  });
  confirmation();
...
module.exports = __webpack_require__(/*! /var/www/html/tamweel-mortgage/tamweel-mortgage-dashboard/resources/js/theme.js */"./resources/js/theme.js");
